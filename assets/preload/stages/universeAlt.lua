...
function onCreate()
	...
	addAnimationByPrefix('faces', 'portraitsNova', 'novaFadeIns',17,true)
	...
	makeAnimatedLuaSprite('broke', 'universe/changShatter', 800,-380) 
	...
	makeAnimatedLuaSprite('rate', 'ratings', 300,200) --ratings
	addAnimationByPrefix('rate', 'sick', 'sickRating',24,false)
	setScrollFactor('rate', 0, 0);
	setObjectCamera('rate', 'hud')
	
	
	--gonna precache this shit so yall PC's won't explode (still prob will)
